    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-blue-400 text-sm font-medium">Active Pipelines</span>
            <Play className="h-5 w-5 text-blue-400" />
          </div>
          <div className="text-2xl font-bold text-white">8</div>
          <div className="text-xs text-blue-300">2 running now</div>
        </div>

        <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-purple-400 text-sm font-medium">Avg. Deploy Time</span>
            <Clock className="h-5 w-5 text-purple-400" />
          </div>
          <div className="text-2xl font-bold text-white">2m 45s</div>
          <div className="text-xs text-purple-300">-30s from last week</div>
        </div>
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
        <div className="p-6 border-b border-white/10">
          ...
          <p className="text-gray-400">Monitor and manage your CI/CD pipelines</p>
        </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-400 mt-1">{pipeline.duration}</div>
                  </div>
