    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-blue-400 text-sm font-medium">Optimization Score</span>
            <span className="text-blue-400 text-lg">%</span>
          </div>
          <div className="text-2xl font-bold text-white">72</div>
          <div className="text-xs text-blue-300">Good efficiency</div>
        </div>

        <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-purple-400 text-sm font-medium">YTD Savings</span>
            <DollarSign className="h-5 w-5 text-purple-400" />
          </div>
          <div className="text-2xl font-bold text-white">$1,240</div>
          <div className="text-xs text-purple-300">From AI optimization</div>
        </div>
      </div>
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 p-6">
          ...
          {costData.map((data, index) => (
            <div key={index} className="flex-1 flex flex-col items-center">
              <div className="w-full max-w-12 flex flex-col space-y-1 mb-2">
                ...
                ></div>
                <div 
                  className="bg-purple-300/50 rounded-t"
        ...
        <div className="flex items-center justify-center space-x-4 mt-4 text-sm">
          ...
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-purple-300/50 rounded"></div>
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
        <div className="p-6 border-b border-white/10">
          ...
          <p className="text-gray-400">Automated cost-saving opportunities identified by AI analysis</p>
        </div>
